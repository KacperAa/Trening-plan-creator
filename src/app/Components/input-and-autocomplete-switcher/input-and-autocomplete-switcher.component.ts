...
import { FormGroupAndAutocompletesTitle } from 'src/app/Interfaces/input-and-autocompletes-switcher.interface';
...
export class InputAndAutocompletesSwitcherComponent {
  ...
  @Input()
  public additionalOptionsData!: FormGroupAndAutocompletesTitle;
  @Output()
